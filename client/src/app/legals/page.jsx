              ...
              <ul className="pl-5 flex flex-col gap-5 font-light text-lightSecondary">
                ...
                <li className="text-lightSecondary hover:text-lightPrimary flex flex-col gap-3">
                  ...
                  <ul className="pl-5 flex flex-col gap-2 font-light text-lightSecondary">
                    ...
                    <li className="text-lightSecondary hover:text-lightPrimary">
                      <Link href="/legals#2-2">2.2 Information We Collect</Link>
                    </li>
                    <li className="text-lightSecondary hover:text-lightPrimary">
          ...
          <div className="w-full lg:w-[70%] flex flex-col gap-10">
            <div className="">
              <article className="w-full flex flex-col gap-5 lg:gap-7 font-light text-lightSecondary leading-tight text-base lg:text-xl">
                ...
                <p>
                  ...
                  mobile, or tablet) when you access our website. They help us
                  recognize your device, remember preferences, and improve user
                  experience.
                </p>
                ...
                <ul className="pl-5 flex flex-col gap-2 list-disc">
                  ...
                  <li>
                    ...
                    Track traffic sources, page views, and user behavior (e.g.,
                    time spent on pages).
                  </li>
                  <li>
                    <span className="text-lightPrimary font-normal">
                ...
                <p>
                  ...
                  traffic, deliver ads, or integrate social media. These parties
                ...
                <ul className="pl-5 flex flex-col gap-2 list-disc">
                  <li>
                    ...
                    By continuing to use our website, you agree to all cookies.
                  </li>
                  <li>
                    <span className="text-lightPrimary font-normal">
                      Browser Settings:
                    </span>{" "}
                    Most browsers allow you to block/delete cookies via settings
                    (e.g., Chrome, Firefox).
                  </li>
                  <li>
                    <span className="text-lightPrimary font-normal">
            ...
            <div className="">
              <article className="w-full flex flex-col gap-5 lg:gap-7 font-light text-lightSecondary leading-tight text-base lg:text-xl">
                ...
                <p>
                  We implement SSL encryption, firewalls, and access controls to
                  protect your data.
                </p>
                <h3
                  id="2-7"
